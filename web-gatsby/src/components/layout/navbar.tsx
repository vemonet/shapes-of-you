...
import { AppBar, Toolbar, Button, Popper, ClickAwayListener, Card, CardContent, CardHeader, IconButton } from '@mui/material';
import Tooltip from '@mui/material/Tooltip';
import CloseIcon from '@mui/icons-material/Close';
import GitHubIcon from '@mui/icons-material/GitHub';
import GrlcApiIcon from '@mui/icons-material/Send';
import ActiveEndpointsIcon from '@mui/icons-material/OfflineBolt';
    ...
    <AppBar title="" position='static'>
      <Toolbar variant='dense'>
        ...
        <Tooltip title='List of active SPARQL endpoints, and their associated queries'>
          <Button className={classes.menuButton} onClick={handleClick} style={{color: theme.palette.common.white}}>
        ...
        <Tooltip title='Access the grlc OpenAPI (which query the SPARQL endpoint)'>
          <Button className={classes.menuButton} style={{color: theme.palette.common.white}} target="_blank" rel="noopener noreferrer"
        ...
        <Tooltip  title='Go to https://github.com/vemonet/shapes-of-you'>
          <Button className={classes.menuButton} style={{color: theme.palette.common.white}} target="_blank"
